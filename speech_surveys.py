...
try:
    data = pd.read_csv(sys.argv[2], usecols=list(range(2, 3)) + list(range(4, 14)))
    ...
    print(
        sys.argv[2],
        "was empty. Please check your csv and make sure it contains data.\n",
    )
    sys.exit(0)
...
try:
    data2 = pd.read_csv(sys.argv[3], usecols=list(range(2, 3)) + list(range(4, 14)))
except FileNotFoundError as err:
    print(err)
    print(
        sys.argv[3],
